...
class Search extends Requestable {
   ...
   _search(path, withOptions = {}) {
      ...
      return this._requestAllPages(`/search/${path}`, requestOptions);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   forRepositories(options) {
      return this._search('repositories', options);
   }
    ...
    */
   forCode(options) {
      return this._search('code', options);
   }
    ...
    */
   forIssues(options) {
      return this._search('issues', options);
   }
    ...
    */
   forUsers(options) {
      return this._search('users', options);
   }
}
