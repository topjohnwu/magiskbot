...
class Requestable {
    ...
    * @param {string} [AcceptHeader='v3+json'] - the accept header for the requests
    */
   constructor(auth, apiBase, AcceptHeader) {
      ...
      this.__AcceptHeader = AcceptHeader || 'v3+json';
    ...
    */
   __getRequestHeaders(AcceptHeader) {
      let headers = {
    ...
    * @param {string} [type='json'] - axios responseType
    * @return {Promise} - the Promise for the http request
    */
   _request(method, path, data, type = 'json') {
      ...
      const headers = this.__getRequestHeaders(AcceptHeader);
    ...
    * @return {Promise} - the promise for the http request
    */
   _request204or404(method, path, data) {
    ...
    */
   _requestAllPages(path, options, results) {
      results = results || [];
      ...
      return this._request('GET', path, options)
         .then((response) => {
            ...
            if (nextUrl && !(options && options.page && typeof options.page !== 'number')) {
               ...
               return this._requestAllPages(nextUrl, options, results);
            }
