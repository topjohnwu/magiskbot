...
class Repository extends Requestable {
  ...
  /**
    ...
    * @return {Promise} - the promise for the http request
    */
   getCollaborators(affiliation = 'all', cb) {
      return this._request('GET', `/repos/${this.__fullname}/collaborators`, { affiliation }, cb);
   }
    ...
    * @return {Promise} - the promise for the http request {Boolean} [description]
    */
   addCollaborator(username, permission='push', cb) {
      return this._request('PUT', `/repos/${this.__fullname}/collaborators/${username}`, { permission }, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   importProject(options, cb) {
      options = options || {};
      options.AcceptHeader = 'barred-rock-preview';
      return this._request('PUT', `/repos/${this.__fullname}/import`, options, cb, '');
   }

   watch(cb) {
      return this._request('PUT', `/repos/${this.__fullname}/subscription`, { subscribed: true, ignored: false }, cb);
   }

   watchAndIgnore(cb) {
      return this._request('PUT', `/repos/${this.__fullname}/subscription`, { subscribed: true, ignored: true }, cb);
   }

   unwatch(cb) {
      return this._request('DELETE', `/repos/${this.__fullname}/subscription`, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   transferProject(options, cb) {
      options = options || {};
      options.AcceptHeader = 'nightshade-preview';
      return this._request('POST', `/repos/${this.__fullname}/transfer`, options, cb);
   }
